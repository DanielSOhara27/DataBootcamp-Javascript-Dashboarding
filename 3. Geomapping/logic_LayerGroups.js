...
var cityMakerLayers = L.layerGroup(cityMarkers);
var stateMarkerLayers = L.layerGroup(stateMarkers);
...
var overlayMaps = {
  "City Population" : cityMakerLayers,
  "State Population" : stateMarkerLayers
};
...
var myMap = L.map("map", {
  ...
  zoom: 5,
  layers: [light, cityMakerLayers, stateMarkerLayers]
});
